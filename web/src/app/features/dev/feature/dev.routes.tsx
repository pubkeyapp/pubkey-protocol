...
import { PubkeyProtocolUiCommunityAnchor, PubkeyProtocolUiCommunityAvatar } from '../../pubkey-community/ui'
                        ...
                        <Group gap="xs" justify="space-between" w="100%">
                          <Group gap="xs" w="100%" align="start" wrap="nowrap">
                            ...
                            <UiStack gap={0} w="100%">
                              ...
                              <UiStack gap="xs">
                                {i.communities?.map((x) => {
                                  const c = communityMap[x.toString()]
                                  return (
                                    <Group key={x.toString()}>
                                      <PubkeyProtocolUiCommunityAvatar community={c} size="xs" radius="xs" />
                                      <PubkeyProtocolUiCommunityAnchor name={c.name} slug={c.slug} size="xs" />
                                    </Group>
                                  )
                                })}
                              </UiStack>
